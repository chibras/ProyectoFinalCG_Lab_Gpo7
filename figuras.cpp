...
void CFiguras::skyboxH(float largo, float altura, float profundidad, GLuint textFr, GLuint textAt, GLuint textIz, GLuint textDr, GLuint textAr)  //Funcion creacion cielo y minimundo
{

	GLfloat vertice[8][3] = {
				{0.5*largo ,-0.5*altura, 0.5*profundidad},    //Coordenadas Vértice 1 V1	  [0]
				{-0.5*largo ,-0.5*altura , 0.5*profundidad},    //Coordenadas Vértice 2 V2	  [1]
				{-0.5*largo ,-0.5*altura , -0.5*profundidad},    //Coordenadas Vértice 3 V3	  [2]
				{0.5*largo ,-0.5*altura , -0.5*profundidad},    //Coordenadas Vértice 4 V4	  [3]
				{0.5*largo ,0.5*altura , 0.5*profundidad},    //Coordenadas Vértice 5 V5	  [4]
				{0.5*largo ,0.5*altura , -0.5*profundidad},    //Coordenadas Vértice 6 V6  	  [5]
				{-0.5*largo ,0.5*altura , -0.5*profundidad},    //Coordenadas Vértice 7 V7	  [6]
				{-0.5*largo ,0.5*altura , 0.5*profundidad},    //Coordenadas Vértice 8 V8	  [7]
	};

	glBindTexture(GL_TEXTURE_2D, textFr);   //textura para la cara frontal
	...
	glBindTexture(GL_TEXTURE_2D, textDr);   //textura para la cara derecha
	...
	* */
	...
	glBindTexture(GL_TEXTURE_2D, textAt);   //textura para la cara de atrás
	...
	glBindTexture(GL_TEXTURE_2D, textIz);   //textura para la cara izquierda
	...
	*/
	...
	glBindTexture(GL_TEXTURE_2D, textAr);   //textura para la cara de arriba
	...
	//glBindTexture(GL_TEXTURE_2D, textAb);   //textura para la cara de abajo
