...
class CFiguras
{
	...
	void skyboxH(float largo, float altura, float profundidad, GLuint textFr, GLuint textAt, GLuint textIz, GLuint textDr, GLuint textAr);  //Funcion creacion cielo y minimundo
